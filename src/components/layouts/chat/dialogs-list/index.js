    ...
    return (
      <div className="dialogs-list">
        <div className="dialogs-list__head">
          <div className="dialogs-list__title-wrap">
            <div className="dialogs-list__title">Сообщения</div>
            <div className="dialogs-list__count"><span>1</span></div>
          </div>       
        ...
        <div className="dialogs-message">
          <div className="dialogs-message__item">
            ...
            <div className="dialogs-message__qute">
              ...
              <div className="dialogs-message__qute-images">
                <img src={avatar} className="dialogs-message__qute-image" alt="avatar"/>
                <img src={avatar2} className="dialogs-message__qute-image" alt="avatar"/>
              </div>
            </div>
          </div>
          ...
          <div className="dialogs-message__item">
            ...
            <div className="dialogs-message__qute">
              ...
              <div className="dialogs-message__qute-images">
                <img src={avatar2} className="dialogs-message__qute-image" alt="avatar"/>
                <img src={avatar3} className="dialogs-message__qute-image" alt="avatar"/>
                <img src={avatar} className="dialogs-message__qute-image" alt="avatar"/>
              </div>
            </div>
          </div>
